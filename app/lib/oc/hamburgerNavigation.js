...
function hamburgernavigation() {
    ...
    function template() {
        return [
            ...
            '.navbar.navbar-hamburger, .navbar.navbar-categories, .navbar.navbar-account, .navbar.navbar-all {min-height:40px; padding-bottom:10px;}',
            '.navbar.navbar-hamburger, .navbar.navbar-categories, .navbar-nav {margin:10px 0px;}',
            '.navbar.navbar-hamburger, .navbar-nav.account > li > a {color:#ffffff}',
